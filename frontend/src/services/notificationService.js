...
export const notifications = { list: async () => unwrap(await NOTIFICATION_API.get('/notification')), create: async (b) => unwrap(await NOTIFICATION_API.post('/notification', b)), update: async (id) => unwrap(await NOTIFICATION_API.put(`/notification/read/${id}`)), remove: async (id) => unwrap(await NOTIFICATION_API.put(`/notification/read/${id}`)), markRead: async (id) => unwrap(await NOTIFICATION_API.put(`/notification/read/${id}`)) };
