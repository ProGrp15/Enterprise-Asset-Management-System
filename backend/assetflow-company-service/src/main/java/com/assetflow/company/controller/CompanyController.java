...
public class CompanyController {
	...
	@GetMapping("/api/{type:department|employee|admin|location|building|floor|room}")
	...
	@GetMapping("/api/{type:department|employee|admin|location|building|floor|room}/{id}")
	...
	@PostMapping("/api/{type:department|employee|admin|location|building|floor|room}")
	...
	@PutMapping("/api/{type:department|employee|admin|location|building|floor|room}/{id}")
	...
	@DeleteMapping("/api/{type:department|employee|admin|location|building|floor|room}/{id}")
