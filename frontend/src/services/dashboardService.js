...
export const getSuperAdminDashboard = async () => {
  ...
  return { ...dashboard, companies: list(companies), stats: { companies: list(companies).length, users: dashboard.employees.length, assets: dashboard.assets.length, subscriptions: 0 } };
};
