...
public class NotificationController {
  ...
  public ApiResponse<?> sendEmail(@RequestBody Map<String, Object> body) {
    boolean sent = email.send((String) body.get("to"), String.valueOf(body.getOrDefault("subject", "AssetFlow notification")), String.valueOf(body.getOrDefault("body", "")));
    return ApiResponse.ok(Map.of("sent", sent, "configured", sent));
  }
