...
import { FaBell, FaBuilding, FaChartBar, FaChartPie, FaClipboardList, FaCog, FaFileAlt, FaMapMarkerAlt, FaTools, FaTruck, FaUsers, FaBoxes, FaSignOutAlt, FaRobot, FaBars, FaSearch, FaChevronDown, FaMoon, FaSun } from 'react-icons/fa';
import { logout } from '../../store/authSlice';
import { notifications } from '../../services/notificationService';
import { useThemeContext } from '../../context/ThemeContext';

const icons={Dashboard:FaChartBar,Analytics:FaChartPie,Employees:FaUsers,Departments:FaUsers,'Asset Categories':FaBoxes,Assets:FaBoxes,Locations:FaMapMarkerAlt,Vendors:FaTruck,'Purchase Orders':FaFileAlt,Maintenance:FaTools,'Asset Requests':FaClipboardList,'Asset Allocation':FaBoxes,'Asset Transfers':FaBoxes,'Asset Returns':FaBoxes,'Repair History':FaTools,Notifications:FaBell,Reports:FaChartBar,'Audit Logs':FaClipboardList,Settings:FaCog,Profile:FaUsers,Companies:FaBuilding,'My Assets':FaBoxes,'Request Asset':FaClipboardList,'AI Assistant':FaRobot};
