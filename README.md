...
The platform supports three primary user roles: **Super Administrator**, **Company Administrator**, and **Employee**, ensuring secure access control and operational transparency. Company administrators can manage organizational resources, departments, employees, vendors, and assets, while employees can request, view, and track allocated assets. The system maintains a complete history of asset allocation, maintenance activities, and user actions through an integrated audit logging mechanism.

The project follows a **microservices-based architecture** and is implemented in **two independent backend technology stacks** to demonstrate enterprise-grade cross-platform development. One backend is developed using **Java Spring Boot (Advanced Java)**, while the second backend is implemented using **Microsoft .NET**, both exposing RESTful APIs with identical business functionality. This dual implementation showcases technology interoperability, scalability, maintainability, and comparative enterprise backend development practices.
